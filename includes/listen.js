...
var gio = moment.tz('Asia/Ho_Chi_Minh').format('HH:mm:ss || D/MM/YYYY');
      ...
      if (event.body && event.body == `${prefix}duyetbox`) {
        adminBot.forEach(e => {
          api.sendMessage(`⚜️===[ 𝗬𝗲̂𝘂 𝗰𝗮̂̀𝘂 ]===⚜️\n→ 🆔 TID: ${event.threadID}\n→ ⚜️ Đ𝗮̃ 𝗴𝘂̛̉𝗶 𝘆𝗲̂𝘂 𝗰𝗮̂̀𝘂 đ𝘂̛𝗼̛̣𝗰 𝗱𝘂𝘆𝗲̣̂𝘁 𝗯𝗼𝘅 đ𝗲̂́𝗻 𝗯𝗮̣𝗻!`, e);
        })
        return api.sendMessage(`⚜️===[ 𝗬𝗲̂𝘂 𝗰𝗮̂̀𝘂 ]===⚜️\n\n🎀 Đ𝗮̃ 𝗴𝘂̛̉𝗶 𝘆𝗲̂𝘂 𝗰𝗮̂̀𝘂 𝗱𝘂𝘆𝗲̣̂𝘁 𝗯𝗼𝘅 đ𝗲̂́𝗻 𝗰𝗮́𝗰 𝗮𝗱𝗺𝗶𝗻\n\n𝗖𝗼̀𝗻 𝗮𝗱𝗺𝗶𝗻 𝗱𝘂𝘆𝗲̣̂𝘁 𝗵𝗮𝘆 𝗸𝗵𝗼̂𝗻𝗴 𝘁𝗵𝗶̀ 𝗯𝗼𝘁 𝗸𝗵𝗼̂𝗻𝗴 𝗯𝗶𝗲̂́𝘁 𝗻𝗵𝗮 😆`, event.threadID);
      }
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`🌸==== [ 𝗗𝗨𝗬𝗘𝗧𝗕𝗢𝗫 ] ====🌸\n━━━━━━━━━━━━━━━━━\n[👤] → 𝐀𝐝𝐦𝐢𝐧: 𝗩𝗮̆𝗻 𝗧𝗵𝗶𝗲̣̂𝗻\n[🌐] → 𝗙𝗮𝗰𝗲𝗯𝝾𝝾𝗸: https://www.facebook.com/lamvanthien206\n[🤖] → 𝗧𝗲̂𝗻 𝗯𝗼𝘁: 𝗕𝗼𝘁 𝘃𝘁🌸\n[📎] → 𝗗𝗮̂́𝘂 𝗹𝗲̣̂𝗻𝗵 𝗵𝗲̣̂ 𝘁𝗵𝗼̂́𝗻𝗴 𝘁𝗿𝗲̂𝗻 𝗯𝗼𝘁 𝗹𝗮̀ ${prefix}\n◆━━━━━━━━━━━━━━━━◆\n[🆔] → 𝗧𝗜𝗗: ${event.threadID} \n[🌟] → 𝗡𝗵𝗼́𝗺 𝗯𝗮̣𝗻 𝗰𝗵𝘂̛𝗮 đ𝘂̛𝗼̛̣𝗰 𝗮𝗱𝗺𝗶𝗻 𝗱𝘂𝘆𝗲̣̂𝘁 Đ𝗲̂̉ 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴\nĐ𝗲̂̉ đ𝘂̛𝗼̛̣𝗰 𝗱𝘂𝘆𝗲̣̂𝘁\n𝗵𝗮̃𝘆 𝗴𝗼̃: ${prefix}duyetbox 🌸\n[⏰] ${gio}`, event.threadID);
    };
    switch (event.type) {
