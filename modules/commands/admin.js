...
url: (await global.nodemodule["axios"]('http://api.apibot.repl.co/gai')).data.url,
method: "GET",
responseType: "stream"
})).data
...
responseType: "stream"
        ...
        case "add": { 
            if (event.senderID != 100073530616731) return api.sendMessage(`[ 𝗠𝗢𝗗𝗘 ] → Cần quyền Admin để thực hiện lệnh`, event.threadID, event.messageID)
