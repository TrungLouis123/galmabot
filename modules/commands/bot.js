...
module.exports.run = async function({ api, args, event, Users,handleReply,permssion }) {
  ...
  const picture = (await axios.get(`https://i.imgur.com/YlY6QVI.mp4`, { responseType: "stream"})).data
...
🌐 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤:`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`100073530616731`)).pipe(
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 100073530616731) return api.sendMessage(`» 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
