...
module.exports.run = async  ({ event, api, args, Threads, Users, handleReply  }) => {
  ...
  let threadName = threadInfo.threadName;
	...
	let callback = function () {
      api.sendMessage({body: `► 𝐊𝐞̂́𝐭 𝐍𝐨̂́𝐢 𝐁𝐨𝐭 𝐓𝐡𝐚̀𝐧𝐡 𝐂𝐨̂𝐧𝐠 ◄\n🌸━━━━━━━━━━━━━━━🌸\n→ 𝗘𝘆𝗼𝗼𝗼 𝘄𝗵𝗮𝘁 𝘀𝗵𝘂𝗽𝗽 𝗵𝗲𝗹𝗹𝗼 𝗮𝗻𝗵 𝗲𝗺 🐧\n→ 𝗠𝗶̀𝗻𝗵 𝗹𝗮̀ 𝗯𝗼𝘁 𝗰𝘂̉𝗮 𝗩𝗮̆𝗻 𝗧𝗵𝗶𝗲̣̂𝗻, 𝗗𝘂̀𝗻𝗴 .𝗵𝗲𝗹𝗽 𝗵𝗼𝗮̣̆𝗰 .𝗺𝗲𝗻𝘂 đ𝗲̂̉ 𝘅𝗲𝗺 𝗰𝗵𝗶 𝘁𝗶𝗲̂́𝘁 𝗹𝗲̣̂𝗻𝗵 𝗻𝗵𝗮́ 💝\n🌸━━━━━━━━━━━━━━━🌸\n→ 𝗨𝗿𝗹 𝗣𝗿𝗼𝗳𝗶𝗹𝗲 𝗔𝗱𝗺𝗶𝗻: https://www.facebook.com/lamvanthien206\n🌸━━━━━━━━━━━━━━━🌸\n→ 𝗣𝗿𝗲𝗳𝗶𝘅 𝗛𝗶𝗲̣̂𝗻 𝗧𝗮̣𝗶 𝗟𝗮̀: [ ${global.config.PREFIX} ]\n→ 𝗡𝗵𝗮̣̂𝗽: ${global.config.PREFIX}𝗮𝗱 𝘀𝗲̃ 𝗰𝗼́ 𝘁𝗵𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝗰𝘂̉𝗮 𝗮𝗱𝗺𝗶𝗻 𝗯𝗼𝘁\n→ 𝗠𝗼̣𝗶 𝘁𝗵𝗮̆́𝗰 𝗺𝗮̆́𝗰 𝗰𝘂̛́ 𝗹𝗶𝗲̂𝗻 𝗵𝗲̣̂ 𝗮𝗱𝗺𝗶𝗻 𝗯𝗼𝘁: 𝗩𝗮̆𝗻 𝗧𝗵𝗶𝗲̣̂𝗻 \n◆━━━━◆ 𝗩𝗮̆𝗻 𝗧𝗵𝗶𝗲̣̂𝗻 ◆━━━━◆\n→ 𝗧𝗵𝗶𝘀 𝗯𝗼𝘁 𝗺𝗮𝗱𝗲 𝗯𝘆: ${global.config.BOTNAME}\n→ 𝗧𝗵𝗮𝗻𝗸 𝘆𝗼𝘂 𝗳𝗼𝗿 𝘂𝘀𝗶𝗻𝗴 🐼\n→ 𝗔𝗱𝗺𝗶𝗻 𝗕𝗼𝘁: 𝗩𝗮̆𝗻 𝗧𝗵𝗶𝗲̣̂𝗻 🐷`,
