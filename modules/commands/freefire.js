...
"https://i.imgur.com/pORKCvc.mp4",
      "https://i.imgur.com/gkenlha.mp4",
      "https://i.imgur.com/PhvkFBx.mp4",
      "https://i.imgur.com/QRn2D9Q.mp4",
      "https://i.imgur.com/NqWTLgt.mp4",
      "https://i.imgur.com/bcTbT2a.mp4",
      "https://i.imgur.com/NL1BRrR.mp4",
      "https://i.imgur.com/Kgc2nYy.mp4"
          ];
     var callback = () => api.sendMessage({body:`==== [ 𝗙𝗥𝗘𝗘 𝗙𝗜𝗥𝗘 ] ====\n━━━━━━━━━━━━━━━━━━\n→ [🧸] : 𝗙𝗿𝗲𝗲 𝗳𝗶𝗿𝗲 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 𝗱𝗮̂𝘆\n→ [📺] : 𝗦𝗼̂́ 𝘃𝗶𝗱𝗲𝗼: ${link.length}\n ━━━━━━━━━━━━━━━━━━\n→ [💓] Đ𝘂̛𝗼̛̣𝗰 𝘂𝗽𝗱𝗮𝘁𝗲 𝗯𝗼̛̉𝗶 𝗩𝗮̆𝗻 𝗧𝗵𝗶𝗲̣̂𝗻`,attachment: fs.createReadStream(__dirname + "/cache/1.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.mp4"), event.messageID);  
