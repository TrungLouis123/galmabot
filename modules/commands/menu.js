module.exports.config = {
    ...
    envConfig: {
        ...
        sendAttachments: {
            ...
            url: 'https://i.imgur.com/8EXur2K.gif'
        }
    }
};
const {
...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "menu.gif")) request("https://i.imgur.com/8EXur2K.gif").pipe(fs.createWriteStream(dirMaterial + "menu.gif"));
                       }
