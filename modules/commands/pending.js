...
module.exports.handleReply = async function({ api, event, handleReply, getText }) {
    ...
    if (isNaN(body) && body.indexOf("c") == 0 || body.indexOf("cancel") == 0) {
        ...
        for (const singleIndex of index) {
            ...
            api.changeNickname(`[ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "𝐁𝐨𝐭 𝐯𝐭 🌸" : global.config.BOTNAME}`, handleReply.pending[singleIndex - 1].threadID, api.getCurrentUserID());
            api.sendMessage("", event.threadID, () => api.sendMessage({body:`► 𝐊𝐞̂́𝐭 𝐍𝐨̂́𝐢 𝐁𝐨𝐭 𝐓𝐡𝐚̀𝐧𝐡 𝐂𝐨̂𝐧𝐠 ◄\n━━━━━━━━━━━━━━━━━━\n→ 𝗘𝘆𝗼𝗼𝗼 𝘄𝗵𝗮𝘁 𝘀𝗵𝘂𝗽𝗽 𝗵𝗲𝗹𝗹𝗼 𝗮𝗻𝗵 𝗲𝗺 🐧\n→ 𝗠𝗶̀𝗻𝗵 𝗹𝗮̀ 𝗯𝗼𝘁 𝗰𝘂̉𝗮 𝗩𝗮̆𝗻 𝗧𝗵𝗶𝗲̣̂𝗻 , 𝗗𝘂̀𝗻𝗴 .𝗵𝗲𝗹𝗽, .𝗺𝗲𝗻𝘂 đ𝗲̂̉ 𝘅𝗲𝗺 𝗰𝗵𝗶 𝘁𝗶𝗲̂́𝘁 𝗹𝗲̣̂𝗻𝗵 𝗻𝗵𝗮́ 💓\n→ 𝗖𝗼́ 𝗴𝗶̀ 𝗸𝗵𝗼̂𝗻𝗴 𝗵𝗶𝗲̂̉𝘂 𝗰𝘂̛́ 𝗹𝗶𝗲̂𝗻 𝗵𝗲̣̂ đ𝗲̂́𝗻 𝗮𝗱𝗺𝗶𝗻 𝗯𝗼𝘁 𝗻𝗵𝗮 🕊\n━━━━━━━━━━━━━━━━━━\n→ 𝗨𝗿𝗹 𝗣𝗿𝗼𝗳𝗶𝗹𝗲 𝗔𝗱𝗺𝗶𝗻: https://www.facebook.com/lamvanthien206`, attachment: fs.createReadStream(__dirname + "/trogiup/menu/297d00688a10464e1f018.mp4")} ,handleReply.pending[singleIndex - 1].threadID));
            count+=1;
