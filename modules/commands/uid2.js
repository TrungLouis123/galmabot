...
var tpk = moment.tz("Asia/Ho_Chi_Minh").format("HH:mm:ss || D/MM/YYYY");
  ...
  if (body.toLowerCase() == "uid" || (body.toLowerCase() == "uidthien") || (body.toLowerCase() == "uidvt") ||
(body.toLowerCase() == "lấy giúp uid") ||  (body.toLowerCase() == "cần uid") || (body.toLowerCase() == "lấy giúp tui uid")) {
